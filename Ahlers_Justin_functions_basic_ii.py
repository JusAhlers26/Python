...
1
0
middle -1 changes how far below 1 it counts"""
countdown = 5
for count in range(countdown, -1, -1):
#for count in reversed(range(1, countdown+2)):
    print(count)
#print('action!')
...
"""above shows in python
3
77
"""
"""below shows in python cmd as
[13,26]
"""
def prt_return(u_ls):
    print(u_ls)
